...
@section('menu')
    ...
    <a href="/posts/{{ $post->id }}">Return</a><br>
@endsection
--}}
        ...
        <form id="editing", action="/posts" method="POST" class="row">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title_post" name="post[title]" class="form-control" value="{{ old('post.title', $post->title )}}">
                    <p class="title__error" style="color:red">{{ $errors->first('post.title') }}</p>
                </div>
                
                <div class="form-group">
                    <label for="body_post"> Body <span class="label label-danger">Requred</span></label>
                    <textarea name="post[body]" id="body_post" rows="10" class="form-control" >{{ old('post.body', $post->body) }}</textarea>
        ...
        <div class="container">
            <form id="editing", action="/posts" method="POST" class="row">
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="form-group">
                        <label for="body_post"> Body <span class="label label-danger">Requred</span></label>
                        <textarea name="post[body]" id="body_post" rows="10" class="form-control" >{{ old('post.title') }}</textarea>
                        <p class="body__error" style="color:red">{{ $errors->first('post.body') }}</p>
                    </div>
                    {{-- <input type="submit" value="Save"/> --}}  {{--
                    <div class="form-group">
